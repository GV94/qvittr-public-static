...
"""
Pre-commit hook to generate manifest.json files for each folder.
...
def generate_manifest(
    ...
    try:
        subprocess.run(
            ["git", "add", str(manifest_file)], capture_output=True, check=True
        )
    except subprocess.CalledProcessError:
        pass  # File might already be tracked
